...
new_image_name = (
    ...
    f"/{acore_ami.StepIdEnum.mysql}-{workflow_param.workflow_id}"
)
...
def create_dynamodb_item():
    with bsm.awscli():
        ...
        base_image = acore_ami.AmiData.iter_query(
            ...
            acore_ami.AmiData.step_id == acore_ami.StepIdEnum.pyenv.value,
        ).one()
        ...
        new_image = acore_ami.create_dynamodb_item_for_new_image(
            ...
            step_id=acore_ami.StepIdEnum.mysql.value,
